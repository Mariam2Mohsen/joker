                    ...
                    <div className="flex justify-center">
                      ...
                      >
                        <div className={`w-3.5 h-3.5 bg-white rounded-full transition-all shadow-sm ${
                          user.account_status === 'Active' ? 'translate-x-5' : 'translate-x-0'
                        }`}></div>
                      </button>
                    </div>
                  </td>
            ...
            {[...Array(totalPages)].map((_, i) => (
              <button
                ...
                className={`w-7 h-7 rounded-md text-[11px] font-black transition-all ${
                  currentPage === i + 1 ? 'bg-[#102C57] text-white shadow-md shadow-[#102C57]/20 scale-110' : 'text-slate-400 hover:bg-[#FEFAF6]'
                }`}
              >
                {i + 1}
              </button>
