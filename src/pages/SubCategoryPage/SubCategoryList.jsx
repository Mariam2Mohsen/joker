                    ...
                    <div className="flex justify-center items-center">
                      ...
                      {activeActionId === item.id && (
                        <div 
                          ...
                          className="absolute right-0 top-[70%] bg-white rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.15)] border border-[#EADBC8] overflow-hidden z-[999] min-w-[150px] animate-in fade-in zoom-in duration-200"
                        >
                          <button 
