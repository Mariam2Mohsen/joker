...
const CustomerSidebar = () => {
  ...
  const menuItems = [
    ...
    { label: "Bookings", icon: <CalendarCheck size={20} />, path: "/dash" },
    { label: "Favorites", icon: <Heart size={20} />, path: "/dash" },
      ...
      <nav className="flex-1 px-4 space-y-2">
        {menuItems.map((item) => (
          <NavLink
            ...
            to={item.path}
            className={({ isActive }) =>
              `flex items-center gap-4 px-6 py-4 rounded-3xl text-[11px] font-black uppercase tracking-[0.25em] transition-all duration-500 relative group ${isActive
