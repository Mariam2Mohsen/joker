        ...
        <MainLayout>
            <div className="bg-[#FEFAF6] pb-24">
                ...
                <section className="relative h-[450px] md:h-[550px] overflow-hidden">
                    ...
                    <div className="relative z-10 container mx-auto px-4 md:px-10 h-full flex flex-col justify-center text-[#FEFAF6]">
                        <div className="max-w-2xl animate-in fade-in slide-in-from-left-8 duration-700">
                           ...
                           <p className="text-lg md:text-xl text-[#FEFAF6]/80 font-medium mb-6 leading-relaxed">
                ...
                <div className="container mx-auto px-4 md:px-10 relative -mt-24 z-20">
                    ...
                    <div className="bg-[#102C57]/90 backdrop-blur-xl border-4 border-[#DAC0A3]/30 p-8 md:p-12 rounded-[3.5rem] shadow-2xl animate-in fade-in slide-in-from-bottom-12 duration-1000">
                        <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
                            <div className="flex-1 text-center lg:text-left">
                                <h2 className="text-3xl md:text-4xl font-black text-[#FEFAF6] uppercase tracking-tighter mb-2">
                                    {service.name}
                                </h2>
                                <p className="text-[#DAC0A3] font-black uppercase text-xs tracking-[0.3em] mb-8">
                                    {service.completedJobs || '150+'} completed jobs
                                </p>
                                
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-[#FEFAF6]/80 font-medium text-sm">
                                    <div className="flex items-center gap-4 justify-center lg:justify-start">
                                        <div className="w-10 h-10 rounded-xl bg-[#DAC0A3]/20 flex items-center justify-center text-[#DAC0A3]">
                            ...
                            <div className="flex flex-col items-center lg:items-end gap-6 min-w-[200px]">
                                <div className="text-right">
                                    ...
                                    <span className="text-6xl font-black text-[#DAC0A3] tracking-tighter ml-2">{service.price}</span>
                                    <span className="text-[#FEFAF6]/60 font-bold ml-2">{service.unit}</span>
                                </div>
                                <Button 
                                    variant="secondary" 
                                    size="lg" 
                                    className="bg-[#DAC0A3] text-[#102C57] font-black px-12 py-5 rounded-2xl shadow-2xl hover:scale-105 transition-transform"
                                >
                                    BOOK NOW
                                </Button>
                            </div>
                    ...
                    <div className="mt-28">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                            {(service.gallery || Array(4).fill(service.image)).map((img, i) => (
                                <div key={i} className="group overflow-hidden rounded-[2rem] h-64 border-4 border-white shadow-xl hover:border-[#DAC0A3] transition-all duration-500">
                                    <img 
                                        src={img} 
