            ...
            <tbody className="divide-y divide-[#FEFAF6]">
              {loading ? (
                ...
                <tr key={cat.category_id} className="hover:bg-[#FEFAF6]/50 transition-colors group">
                  ...
                  <td className="py-5 px-8 text-slate-500 text-[11px] text-center font-bold">
                  ...
                  <td className="py-5 px-8">
                    <div className="flex justify-center">
                      <button
                        ...
                        className={`w-11 h-5 flex items-center rounded-full p-1 transition-all duration-300 ${cat.status === 'active' ? 'bg-green-500 shadow-sm shadow-green-100' : 'bg-[#EADBC8]'}`}
                      >
                        <div className={`w-3.5 h-3.5 bg-white rounded-full transition-all shadow-sm ${cat.status === 'active' ? 'translate-x-5' : 'translate-x-0'}`}></div>
                      </button>
                    </div>
                  </td>
                  <td className="py-5 px-8 text-center">
                    <div className="relative flex justify-center">
                      ...
                      {activeActionId === cat.category_id && (
                        <div className="absolute right-full mr-2 top-0 bg-white rounded-xl shadow-2xl border border-[#EADBC8] overflow-hidden z-[100] min-w-[120px]">
                          <Link 
