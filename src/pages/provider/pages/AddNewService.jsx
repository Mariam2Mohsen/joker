...
export const AddNewServicePage = () => {
  ...
  useEffect(() => {
    const fetchSubCategories = async () => {
      if (form.category) {
        try {
          const res = await axios.get(`https://joker-hm0k.onrender.com/api/subcategories?category_id=${form.category}`);
          if (res.data.success) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      for (const file of form.galleryImages) {
        ...
        const res = await axios.post("https://joker-hm0k.onrender.com/api/users/upload_image", formData);
      ...
      const res = await axios.post("https://joker-hm0k.onrender.com/api/provider/services/service-requests", payload, {
    ...
    <div className="flex flex-col h-screen overflow-hidden bg-[#FEFAF6] font-sans selection:bg-[#102C57] selection:text-white">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 p-10 overflow-auto scroll-smooth relative">
          ...
          <div className="max-w-6xl mx-auto py-10 animate-in fade-in slide-in-from-bottom-12 duration-1000 items-start space-y-12">
