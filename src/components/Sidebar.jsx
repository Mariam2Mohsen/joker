      ...
      <nav className="flex-1 py-4 space-y-1">
        ...
        <div>
          ...
          {openMenus.services && (
            ...
            {/* Provider Management */}
        <div>
          <div onClick={() => toggleMenu('providers')} className="flex items-center justify-between p-4 cursor-pointer text-[#FEFAF6]/80 hover:text-[#FEFAF6] transition-all group">
            <div className="flex items-center gap-4 text-[13px] font-bold">
              <FaHandshake size={16} /> Providers
            </div>
            <div className="flex items-center gap-2">
              {openMenus.providers ? <FaChevronUp size={10} /> : <FaChevronDown size={10} />}
            </div>
          </div>
